...
class TrainingProdReadinessBuilder:
    ...
    def build(self):
        ...
        checks = [
            ...
            {"area": "model_artifact_output", "ready": model_count >= 2, "level": "governed" if model_count == len(self.required_model_files) else "partial"},
        ...
        payload = {
            ...
            "summary": {
                ...
                "overall_conclusion": "prelive_grade" if ready_count >= 7 else "not_live_grade_yet",
