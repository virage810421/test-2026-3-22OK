...
class FormalTradingSystemV78:
    ...
    def boot(self):
        log('=' * 60)
        log('🚀 啟動 正式交易主控版_v78')
        log('📈 v78 non-broker massive upgrade：weighted completion + training bootstrap + paper odd-lot sizing：ON')
    ...
    def run(self):
        ...
        manifest_path = PATHS.runtime_dir / 'run_manifest_v78.json'
