...
class LiveReadinessGate:
    MODULE_VERSION = 'v86_split_readiness'
    ...
    def evaluate(self, normalized_df=None):
        ...
        executable_score = prelive_score
        result = {
            ...
            'warnings': warnings,
            'prelive_ready': prelive_score >= 4 and len([x for x in hard_blocks if x == 'some_order_payloads_fail_tw_market_rules']) == 0,
