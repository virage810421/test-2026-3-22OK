...
def setup_tsql_database():
    ...
    clear_chips = input("❓ 是否要一併刪除【法人籌碼庫 (daily_chip_data)】？(選 n 可保留歷史籌碼) (y/n): ")
    clear_funds = input("❓ 是否要一併刪除【基本面財報庫 (fundamentals_clean)】？(選 n 可保留歷史財報) (y/n): ")
    clear_rev_simple = input("❓ 是否要一併刪除【最新月營收簡表 (monthly_revenue_simple)】？(選 n 可保留) (y/n): ")
    clear_rev_industry = input("❓ 是否要一併刪除【產業月營收表 (stock_revenue_industry_tw)】？(選 n 可保留) (y/n): ")
