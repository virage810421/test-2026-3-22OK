...
def judge_candidate(candidate: dict[str, Any], baseline: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    return {'enabled': True, 'ai_score': round(score, 4), 'hard_gate_pass': hard_gate_pass, 'recommended_status': recommended_status, 'reason': reasons, 'detail': {'profit_factor': pf, 'win_rate': win, 'max_drawdown': mdd, 'trade_count': trades, 'cost_after_ev': ev}}
