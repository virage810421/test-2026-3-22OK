...
class FormalTradingSystemV29:
    ...
    def boot(self):
        ...
        self.ai_registry.write_path, self.ai_registry_payload = self.ai_registry.build()
        ...
        self.audit.append("boot", {"system_name": CONFIG.system_name, "package_version": getattr(CONFIG, "package_version", "v29")})
    ...
    def run(self):
        ...
        report_path = self.report_builder.save(
            ...
            stage_results={
                ...
                "ai_pipeline_registry_path": str(self.ai_registry.write_path),
