...
class FormalTradingSystemV68:
    ...
    def boot(self):
        ...
        log("🧱 v68 auto price scan + training input manifest：ON")
    ...
    def run(self):
        ...
        log("✅ v68 主控完成：已補 auto price scan / training input manifest / full progress report")
        return {
