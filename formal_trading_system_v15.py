...
from fts_pipeline import ExternalScriptRunner, StageManager
...
class FormalTradingSystemV15:
    def __init__(self):
        ...
        self.stage_manager = StageManager(self.script_runner)
